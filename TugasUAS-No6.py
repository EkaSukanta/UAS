...
class Pegawai(Connection):
    ...
    def create(self):
        ...
        try:
            ...
            print(
                e, "warning: gagal membuat data, pastikan anada telah berhasil membaut 'database' sebelumnya")
...
class Mobil(Connection):
    ...
    def create(self):
        ...
        cursor = self.con.cursor()
        val = (nama_mobil, jenis_mobil, warna, tahun, stnk_atas_nama, no_rangka,
               no_mesin, no_polisi, status_pajak, berlaku_stnk, harga_sewa, status)
        query = ("INSERT INTO " + self.tablename +
